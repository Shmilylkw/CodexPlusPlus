...
export const EN_PLAIN: Record<string, string> = {
  ...
  "已重新检测全部可测速供应商的响应延迟。": "Retesting response latency for every measurable provider.",
  "已切换到聚合供应商；Codex增强已设为完全增强，真实对话会按所选策略轮转成员。":
    "Switched to the aggregate provider; Codex enhancements are set to full, and real conversations rotate members using the selected strategy.",
  "已按此供应商切换到纯 API；Codex增强已设为完全增强。":
    "Switched this provider to pure API; Codex enhancements are set to full.",
  "已按此供应商使用官方登录，并混入 API Key；Codex增强已设为完全增强。":
    "Using official login for this provider with its API Key mixed in; Codex enhancements are set to full.",
  "已按此供应商切回官方登录；Codex增强已设为完全增强。":
    "Switched this provider back to official login; Codex enhancements are set to full.",
